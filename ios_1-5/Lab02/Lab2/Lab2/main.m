...
NSTimeInterval eightDays = 8*24*60*60;
   ...
   // invoking formatter
    ...
    NSLog(@"Eight days from Today's Date: %@",Date_eightfromnow);
...
//Invoking built in method to answer the trivial question
    ...
    NSLog(@" The earlier date between: 8/27/12 and 9/13/12 is: %@",sealierdate1);
...
//Construct date object from date components
    ...
    NSLog(@" The later date between: 1/10/12 and 12/20/11 is: %@",sealierdate2);
}
void PrintRNumb(){
